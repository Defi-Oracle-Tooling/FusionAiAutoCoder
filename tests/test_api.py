...
from src.types import TorchVersionInfo, GPUCheckResult
...
def mock_hybrid_workflow() -> MagicMock:
    ...
    with patch("src.main.hybrid_workflow") as mock:
        async def mock_workflow(task_type: str, task_data: Dict[str, Any]) -> Dict[str, Any]:
...
async def test_generate_code(
    client: TestClient,
    mock_hybrid_workflow: MagicMock
) -> None:
